...
- [Awesome Angular ![Awesome](https://github.com/sindresorhus/awesome) ![Build Status](https://travis-ci.org/AngularClass/awesome-angular)](#awesome-angular-awesomehttpsgithubcomsindresorhusawesome-build-statushttpstravis-ciorgangularclassawesome-angular)
    ...
    - [Angular](#angular)
      ...
      - [Community](#community)
      - [Angular Team on twitter](#angular-team-on-twitter)
    ...
    - [Universal Angular 2](#universal-angular-2)
      ...
      - [Universal Seed Projects](#universal-seed-projects)
  - [* angular-universal-heroku-starter - Angular 7 Universal Starter Kit with Server-Side Rendering (SSR) and easy deployment to Heroku](#angular-universal-heroku-starter---angular-7-universal-starter-kit-with-server-side-rendering-ssr-and-easy-deployment-to-heroku)
    - [Angular 2 in TypeScript](#angular-2-in-typescript)
      - [TypeScript General Resources](#typescript-general-resources)
      - [TypeScript Seed Projects](#typescript-seed-projects)
      - [Ionic 2 in Angular 2](#ionic-2-in-angular-2)
        - [Ionic 2 General Resources](#ionic-2-general-resources)
      - [Angular 2 in Cordova](#angular-2-in-cordova)
        - [Cordova Seed Projects](#cordova-seed-projects)
    - [Angular 2 in Dart](#angular-2-in-dart)
      - [Dart General Resources](#dart-general-resources)
      - [Dart Seed Projects](#dart-seed-projects)
      - [Dart Demo, Samples, and Examples](#dart-demo-samples-and-examples)
    - [Angular 2 in Traceur](#angular-2-in-traceur)
      - [Traceur General Resources](#traceur-general-resources)
      - [Traceur Seed Projects](#traceur-seed-projects)
    - [Angular 2 in Babel](#angular-2-in-babel)
      - [Babel General Resources](#babel-general-resources)
      - [Babel Angular 2 Online Playground](#babel-angular-2-online-playground)
      - [Babel Seed Projects](#babel-seed-projects)
      - [Babel Demo, Samples, and Examples](#babel-demo-samples-and-examples)
      - [Babel Plugins](#babel-plugins)
    - [Angular 2 in ES5](#angular-2-in-es5)
        - [ES5 General Resources](#es5-general-resources)
      - [ES5 Seed Projects](#es5-seed-projects)
      - [Meteor in Angular 2](#meteor-in-angular-2)
        - [Meteor General Resources](#meteor-general-resources)
      - [Meteor Seed Projects](#meteor-seed-projects)
      - [Angular 2 in NativeScript](#angular-2-in-nativescript)
        - [NativeScript General Resources](#nativescript-general-resources)
      - [NativeScript Seed Projects](#nativescript-seed-projects)
      - [Angular 2 in React Native](#angular-2-in-react-native)
        - [React Native General Resources](#react-native-general-resources)
      - [React Native Projects](#react-native-projects)
      - [React Native Seed Projects](#react-native-seed-projects)
    - [Angular 2 in Haxe](#angular-2-in-haxe)
        - [Haxe General Resources](#haxe-general-resources)
      - [Haxe Seed Projects](#haxe-seed-projects)
    - [Angular 2 in Scala](#angular-2-in-scala)
        - [Scala General Resources](#scala-general-resources)
      - [Scala Seed Projects](#scala-seed-projects)
    - [Angular 2 components with Bit](#angular-2-components-with-bit)
        - [Bit Resources](#bit-resources)
      - [Security](#security)
      - [NgRx](#ngrx)
  - [License](#license)
